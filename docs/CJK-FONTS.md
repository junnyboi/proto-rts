...
ManusCC0 Regular, Medium and Bold stay primary. The glyph fallback `assets/runtime/fonts/ManusGameSC-Common.woff2` is a **992,160-byte WOFF2**, with a hard maximum of **1,000,000 bytes**. It covers **6,547 Unicode codepoints**: all 3,500 first-level and 3,000 second-level characters in the 2013 Table of General Standard Chinese Characters, plus 47 shipped UI/name/symbol characters. This targets common Simplified Chinese. Rare names, every CJK extension, Traditional Chinese, other scripts and emoji are not guaranteed.
